...
/**
 * KineticText — Magic UI typographic hover: characters animate font
 * weight (and stroke) as the cursor passes across the word. Subtle,
 * type-only motion — fits the design law's restraint.
 */
