...
// Vendored from React Bits (reactbits.dev) — LaserFlow-JS-CSS, olive-tuned.
// Kept upstream-faithful; targeted disables document vendored patterns
// that trip our stricter lint (impure ref initializers, etc.).
...
export const LaserFlow = ({
  ...
  // Vendored upstream pattern: performance.now() in a ref initializer is
  // impure during render — intentional here (baseline FPS timestamp).
