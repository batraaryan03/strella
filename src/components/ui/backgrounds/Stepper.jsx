    ...
    <motion.div onClick={handleClick} className="step-indicator" style={disableStepIndicators ? { pointerEvents: 'none', opacity: 0.5 } : {}} animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          // Stellar brand olive — #636B2F (active) + olive-bright #97a75a (complete)
          active: { scale: 1, backgroundColor: '#636B2F', color: '#636B2F' },
          complete: { scale: 1, backgroundColor: '#636B2F', color: '#97a75a' }
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#636B2F' }
  };
